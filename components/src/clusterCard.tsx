...
/**
 * Renders a cluster card component.
 *
 * @param {ClusterCardProps} props - The props for the ClusterCard component.
 * @returns {JSX.Element} The rendered ClusterCard component.
 */
