...
export function HeroPartial() {
  return (
    <div className="relative block w-full overflow-visible">
      <svg
        id="bg-hero"
        className="w-300 absolute left-1/2 -z-10 mx-auto -mt-16 box-border flex -translate-x-1/2 justify-center align-middle"
      ...
      <div className="prose mx-auto flex flex-col items-end px-4 lg:flex-row lg:items-start">
      ...
      <div className="prose mx-auto mt-96 px-4 md:pb-64">
